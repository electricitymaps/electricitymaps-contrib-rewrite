...
const translateWithTranslator = (translator, key, ...arguments_) => {
...
export const translate = (key, ...arguments_) =>
...
export const useTranslation = () => {
  ...
  const __ = (key, ...arguments_) => translateWithTranslator(t, key, ...arguments_);
  return { __, i18n };
};
...
export const getCountryName = (zoneCode) =>
