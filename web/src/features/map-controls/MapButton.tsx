...
export default function MapButton(properties: MapButtonProperties): ReactElement {
  ...
  return (
    <TooltipWrapper tooltipContent={tooltipText}>
      <Toggle.Root
        onClick={onClick}
        className={`pointer-events-auto flex h-8 w-8 items-center justify-center rounded bg-white text-left drop-shadow transition dark:bg-gray-900 dark:hover:bg-gray-800 ${className}`}
